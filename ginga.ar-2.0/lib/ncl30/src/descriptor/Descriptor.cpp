...
const std::string &Descriptor::getExplicitDuration() {
...
void Descriptor::setExplicitDuration( std::string &dur ) {
...
bool Descriptor::addInputTransition( bptnt::Transition* transition, int somePos ) {
	unsigned int pos;
	pos = (unsigned int) inputTransitions->size();
...
bool Descriptor::addOutputTransition( bptnt::Transition* transition, int somePos ) {
	unsigned int pos;
 	pos = (unsigned int) outputTransitions->size();
