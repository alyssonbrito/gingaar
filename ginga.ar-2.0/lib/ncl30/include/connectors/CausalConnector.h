...
public:
	explicit CausalConnector( const std::string &id );
	CausalConnector( const std::string &, ConditionExpression *condition, Action *action );
...
private:
	void getConditionRoles( ConditionExpression *condition, std::vector<Role*>* roles );

	void getActionRoles( Action *action, std::vector<Role*>* roles );
