-- Test posting events of class key, type press and keys 0 to 9, red, green, blue and yellow
...
function nclHandler(evt)
  ...
  if evt.class == 'key' then
    assertEquals(evt.type, 'press', 'Se esperaba recibir el evento de type press' )
