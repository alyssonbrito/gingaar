...
void *NclPresentationSpecificationParser::parseDescriptor( DOMElement *parentElement ) {
	...
	parentObject = createDescriptor( parentElement );
	...
	for (int i = 0; i < (int) elementNodeList->getLength(); i++) {
		...
		if (node->getNodeType() == DOMNode::ELEMENT_NODE) {
			...
			if (elementTagName.compare( "descriptorParam" ) == 0) {

				elementObject = parseDescriptorParam( element );
...
void *NclPresentationSpecificationParser::parseDescriptorBase( DOMElement *parentElement ) {
...
void *NclPresentationSpecificationParser::parseDescriptorBind( DOMElement *parentElement ) {
	return createDescriptorBind( parentElement );
}

void *NclPresentationSpecificationParser::parseDescriptorParam( DOMElement *parentElement ) {
