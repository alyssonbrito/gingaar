...
void *NclStructureConverter::createBody( DOMElement *parentElement ) {
...
void *NclStructureConverter::posCompileBody( DOMElement *parentElement, void *parentObject ) {
...
void *NclStructureConverter::createHead( DOMElement *parentElement ) {

	// nothing to do
	return parentElement;
}

void *NclStructureConverter::createNcl( DOMElement *parentElement ) {
