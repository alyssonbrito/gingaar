...
namespace converter {
namespace ncl {
class NclTransitionConverter: public bptcfn::NclTransitionParser
{
public:
	explicit NclTransitionConverter( bptcf::DocumentParser *documentParser );
	void addTransitionToTransitionBase( void* parentObject, void* childObject );

	void* createTransitionBase( DOMElement* parentElement );

	void* createTransition( DOMElement *parentElement );
