...
private:
	...
	bptnc::ContextNode *createStandardContext( DOMElement *parentElement );
	bptnr::ReferNode *createReferNodeContext( DOMElement *parentElement );
	bptnr::ReferNode *createReferNodeMedia( DOMElement *parentElement );
	bptnc::ContentNode *createStandardMedia( DOMElement *parentElement );
	bool hasValidId(DOMElement *parentElement);

public:
	bptnc::Node *createContext( DOMElement *parentElement );
	bptnc::Node *createMedia( DOMElement *parentElement );
	bptnc::ContextNode *posCompileContext( DOMElement *parentElement, bptnc::ContextNode *parentObject );
