...
namespace converter {
namespace ncl {
class NclStructureConverter: public bptcfn::NclStructureParser
{
public:
	explicit NclStructureConverter( bptcf::DocumentParser *documentParser );
	...
	virtual void addDescriptorBaseToHead( void *childObject );

	virtual void addRegionBaseToHead( void *childObject );

	virtual void addTransitionBaseToHead( void* childObject );
	...
	virtual void addRuleBaseToHead( void *childObject );
	virtual void addConnectorBaseToHead( void *childObject );

	virtual void *createBody( DOMElement *parentElement );

private:
	void solveNodeReferences( bptnc::CompositeNode *composition );
...
public:
	...
	virtual void* createNcl( DOMElement *parentElement );

	void addMetaToHead( void* childObject );
	void addMetadataToHead( void* childObject );
};
}
}
}
