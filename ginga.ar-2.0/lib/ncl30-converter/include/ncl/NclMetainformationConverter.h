...
namespace converter {
namespace ncl {
class NclMetainformationConverter: public bptcfn::NclMetainformationParser
{
public:
	explicit NclMetainformationConverter( bptcf::DocumentParser* documentParser );
	void* createMeta( DOMElement* parentElement );
