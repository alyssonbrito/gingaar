...
public:
	...
	bptncon::CompoundCondition *parseCompoundCondition( DOMElement *parentElement );
	bptncon::AssessmentStatement *parseAssessmentStatement( DOMElement *parentElement );
	bptncon::CompoundStatement *parseCompoundStatement( DOMElement *parentElement );
	bptncon::CompoundAction *parseCompoundAction( DOMElement *parentElement );
	bptncon::CausalConnector *parseCausalConnector( DOMElement *parentElement );
	void *parseConnectorBase( DOMElement *parentElement );
	
	virtual bptncon::SimpleCondition *createSimpleCondition( DOMElement *parentElement )=0;
	virtual bptncon::CompoundCondition *createCompoundCondition( DOMElement *parentElement )=0;
	...
	virtual bptncon::AssessmentStatement *createAssessmentStatement( DOMElement *parentElement )=0;
	...
	virtual bptncon::AttributeAssessment *createAttributeAssessment( DOMElement *parentElement )=0;
	virtual bptncon::ValueAssessment *createValueAssessment( DOMElement *parentElement )=0;
	
	virtual bptncon::CompoundStatement *createCompoundStatement( DOMElement *parentElement )=0;
	virtual void addStatementToCompoundStatement(bptncon::CompoundStatement *parentObject, bptncon::Statement *childObject)=0;
	
	virtual bptncon::SimpleAction *createSimpleAction( DOMElement *parentElement )=0;
	virtual bptncon::CompoundAction *createCompoundAction( DOMElement *parentElement )=0;
	
	virtual void addActionToCompoundAction(bptncon::CompoundAction *parentObject, bptncon::Action *childObject)=0;
	virtual bptn::Parameter *createConnectorParam( DOMElement *parentElement )=0;
	virtual bptncon::CausalConnector *createCausalConnector( DOMElement *parentElement )=0;
	...
	virtual bptncon::ConnectorBase *createConnectorBase( DOMElement *parentElement )=0;
	virtual void addImportBaseToConnectorBase(bptncon::ConnectorBase *parentObject, DOMElement *childObject )=0;
