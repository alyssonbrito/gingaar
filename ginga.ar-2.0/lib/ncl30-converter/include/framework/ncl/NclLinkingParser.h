...
{
public:
	explicit NclLinkingParser( bptcf::DocumentParser *documentParser );
	void *parseBind( DOMElement *parentElement, void *objGrandParent );
	virtual void *createBind( DOMElement *parentElement, void *objGrandParent )=0;

	virtual void addBindParamToBind( void *parentObject, void *childObject )=0;

	void *parseLinkParam( DOMElement *parentElement );
	virtual void *createLinkParam( DOMElement *parentElement )=0;

	void *parseBindParam( DOMElement *parentElement );
	virtual void *createBindParam( DOMElement *parentElement )=0;

	void *parseLink( DOMElement *parentElement, void *objGrandParent );
	virtual void *createLink( DOMElement *parentElement, void *objGrandParent )=0;
