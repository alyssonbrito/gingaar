...
public:
	...
	virtual void* createBody( DOMElement *parentElement )=0;
	...
	virtual void* parseHead( DOMElement *parentElement );

	virtual void* createHead( DOMElement *parentElement )=0;
	...
	virtual void* parseNcl( DOMElement *parentElement );

	virtual void* createNcl( DOMElement *parentElement )=0;
