...
public:
	...
	bptnc::Node *parseMedia( DOMElement *parentElement );
	bptnc::Node *parseContext( DOMElement *parentElement );
	
	virtual bptnc::ContextNode *posCompileContext( DOMElement *parentElement, bptnc::ContextNode *parentObject);
	
	virtual bptnc::Node* createMedia( DOMElement *parentElement )=0;
	virtual void addElementToMedia( bptnc::Node *parentObject, void *childObject )=0;
	
	virtual bptnc::Node *createContext( DOMElement *parentElement )=0;
