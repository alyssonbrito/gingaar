...
{
public:
	explicit NclMetainformationParser( bptcf::DocumentParser *documentParser );
	void *parseMeta( DOMElement *parentElement );

	virtual void* createMeta( DOMElement *parentElement )=0;
