...
const double PresentationEvent::UNDEFINED_INSTANT = ncl_util::NaN();

PresentationEvent::PresentationEvent( const std::string &id, components::ExecutionObject* executionObject, ContentAnchor* anchor, ncl30presenter::event::EventManager *manager ) :
		AnchorEvent( id, executionObject, anchor, manager ) {
...
void PresentationEvent::setRepetitionSettings( long repetitions, double repetitionInterval ) {
...
void PresentationEvent::decrementNumPresentation(){
       numPresentations--;
}
