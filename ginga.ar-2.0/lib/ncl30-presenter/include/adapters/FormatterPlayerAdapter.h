...
public:
	...
	//	Can be called from FormatterFocusManager. It's assumed that will be followed by userEventReceived for same key.
	void setPlayerKeyHandler();
	void setFormatterKeyHandler();
...
protected:
	...
	static const float FONT_PT_TO_PX = (4.0 / 3.0);
	std::string getProperSize( const std::string &value );
