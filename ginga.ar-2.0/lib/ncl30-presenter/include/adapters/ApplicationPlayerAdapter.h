...
public:
	virtual bool stop();
	virtual void onEvent( player::event::evtType::type type, player::event::evtAction::type action, const std::string &nodeId, const std::string &parameter = "", const std::string &value = "" );
