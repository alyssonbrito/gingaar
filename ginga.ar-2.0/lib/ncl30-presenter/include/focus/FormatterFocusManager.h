...
public:
	...
	void setStartComposition( bool isComposition );
	void focusSmallest();
...
protected:
	...
	void changeSettingState( const std::string &name, const std::string &act, const std::string &value );

private:
	bool isHandler;

	std::vector<ExecutionObject*> _objects;
	ExecutionObject* currentFocus;
	ExecutionObject* selectedObject;
	PlayerAdapterManager* playerManager;
	emconverter::FormatterConverter* converter;
	player::System *_sys;
	bool isStartComposition;
