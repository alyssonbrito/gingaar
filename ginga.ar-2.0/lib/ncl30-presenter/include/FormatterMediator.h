...
private:
	...
	bool isEmbedded;
	player::System *_sys;
	PresentationEngineManager *_pem;
...
public:
	...
	FormatterScheduler* getFormatterScheduler() { return scheduler; }
...
public:
	...
	void NCLPlayerNotification(short actionType, std::string propValue);
	void setPEM(PresentationEngineManager *pem);
	inline PresentationEngineManager *getPEM() {return _pem;}
