...
public:
	...
	double getExpectedDurationTime();
	...
	virtual bool getParentsVisibility( void );
	...
	::util::key::Keys getInputEvents();
	bool isTransitionInVisible();
	void setTransitionInVisible( bool visible );
