...
public:
	PresentationEvent( const std::string &id, components::ExecutionObject* executionObject, ContentAnchor* anchor, ncl30presenter::event::EventManager *manager );
