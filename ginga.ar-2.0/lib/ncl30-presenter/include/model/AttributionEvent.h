...
public:
	AttributionEvent( const std::string &id, components::ExecutionObject* eObject, PropertyAnchor* anchor, ncl30presenter::event::EventManager *manager, player::System *system );
