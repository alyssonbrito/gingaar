...
namespace model {
namespace link {
class LinkTransitionTriggerCondition: public LinkTriggerCondition, public IEventListener
{
...
public:
	LinkTransitionTriggerCondition( FormatterEvent* event, short transition, player::System *system, RuleAdapter* ruleAdapter );
	virtual ~LinkTransitionTriggerCondition();

	listenerType( LinkTransitionTriggerCondition );
	void stopListening( void* event );

	virtual void eventStateChanged( void* someEvent, short transition, short previousState );
