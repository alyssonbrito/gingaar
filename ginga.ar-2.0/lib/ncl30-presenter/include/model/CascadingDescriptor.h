...
public:
	...
	const std::string &getExplicitDuration();
	bool setExplicitDuration( std::string &dur );
	bool getFreeze();
	...
	string getMoveDown();
	void setMoveDown( const std::string &index );
	string getMoveLeft();
	void setMoveLeft( const std::string &index );
	string getMoveRight();
	void setMoveRight( const std::string &index );
	string getMoveUp();
	void setMoveUp( const std::string &index );
	...
	void updateData( GenericDescriptor* descriptor );
