...
if (NOT MSVC)
  ...
  list(APPEND GTK2_INCLUDE_DIRS ${FREETYPE2_INCLUDE_DIRS})
  list(APPEND GTK2_LIBRARIES ${FREETYPE2_LIBRARIES})
...
foreach(_GTK2_component ${GTK2_FIND_COMPONENTS})
    if(_GTK2_component STREQUAL "gtk")
        ...
        _GTK2_FIND_INCLUDE_DIR(GTK2_GTHREAD_INCLUDE_DIR glib/gthread.h)
        _GTK2_FIND_LIBRARY    (GTK2_GTHREAD_LIBRARY gthread false true)

        _GTK2_FIND_INCLUDE_DIR(GTK2_PANGOCAIRO_INCLUDE_DIR pango/pangocairo.h)
        ...
        if(UNIX)
            _GTK2_FIND_LIBRARY    (GTK2_GDK_LIBRARY gdk-directfb false true)
            _GTK2_FIND_LIBRARY    (GTK2_GTK_LIBRARY gtk-directfb false true)
        else()
            _GTK2_FIND_INCLUDE_DIR(GTK2_PANGOWIN32_INCLUDE_DIR pango/pangowin32.h)
            _GTK2_FIND_LIBRARY    (GTK2_PANGOWIN32_LIBRARY pangowin32 false true)
