...
TEST_F( Ginga, descriptor_fontSize7 ) {
	ASSERT_TRUE( play("descriptor/fontSize/fontSize7.ncl") );
	ASSERT_TRUE( compareTo("standardText_size1000") );
}
TEST_F( Ginga, descriptor_fontSize8 ) {
	ASSERT_TRUE( play("descriptor/fontSize/fontSize8.ncl") );
	ASSERT_TRUE( compareTo("black720x576") );
}
